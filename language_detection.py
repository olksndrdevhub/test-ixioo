...
class LanguageDetector:
    ...
    @staticmethod
    def _evaluate_match_percentage_with_language(count_list_of_words: int, dict_of_languages_with_counted_matching_words: dict) -> dict:
        """
        Evaluates matching percentage with every language
        :param count_list_of_words: quantity of words in a list in the unidentified language
        :type count_list_of_words: int
